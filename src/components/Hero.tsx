      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 lg:py-40">
        <div className="md:w-3/5">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-navy-700 dark:text-white leading-tight animate-fade-in">
            Expert Actuarial <br />
            <span className="text-gold-500">Consultancy Services</span>
          </h1>
          
          <p className="mt-6 text-lg text-navy-600 dark:text-gray-300 max-w-2xl animate-fade-in" style={{animationDelay: "0.2s"}}>
            Providing comprehensive actuarial solutions for insurance companies, employee welfare benefits, retirement funds and health warranty, and actuary workshop for over 20 years.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-4 animate-fade-in" style={{animationDelay: "0.4s"}}>
            ...
            <Link to="/contact">
              <Button variant="outline" className="border-navy-600 text-navy-600 hover:bg-navy-50 dark:border-white dark:text-white dark:hover:bg-navy-700 px-8 py-6 text-lg">
                Contact Us
              </Button>
            </Link>
          </div>
